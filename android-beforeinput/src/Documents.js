...
export default [
	...
	{
		dom: (keyStart) => (
			<div class="toplevel" data-slate-object="block" data-key={keyStart + 1}>
				<div class="paragraph" data-slate-object="block" data-key={keyStart + 2}>
					<span class="styled" data-slate-object="block" data-key={keyStart + 3}>
						<span data-slate-object="text" data-key={keyStart + 4}>
							<span data-slate-leaf="true" data-offset-key={`${keyStart + 4}:0`}>
								<span data-slate-string="true">Some{" "}</span>
							</span>
					...
					<span class="default-element" data-slate-object="block" data-key={keyStart + 7}>
						<span data-slate-object="text" data-key={keyStart + 8}>
							<span data-slate-leaf="true" data-offset-key={`${keyStart + 8}:0`}>
								<span data-slate-string="true">{" "}</span>
							</span>
					...
					<span class="default-element" data-slate-object="block" data-key="18">
						<span data-slate-object="text" data-key={keyStart + 13}>
							<span data-slate-leaf="true" data-offset-key={`${keyStart + 13}:0`}>
								<span data-slate-string="true">{"\na\nSome "}</span>
							</span>
						</span>
						<span data-slate-object="text" data-key={keyStart + 14}>
							<span data-slate-leaf="true" data-offset-key={`${keyStart + 14}:0`}>
								<span class="orange">
									<span data-slate-string="true">additionnal text</span>
								</span>
							</span>
